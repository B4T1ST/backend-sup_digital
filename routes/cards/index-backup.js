...
async function retornaDados(res){
    ...
    try{
        ...
        */
        ...
        const jsonEstaticoUsuario = {
            "nome": "SIMONE GARCIA DAS DORES",
            "almope": "4780542",
            "campanha": "Operação - BRADESCO SAC DIFERENCI...",
            "isSupervisor": false
        };
        const jsonEstaticoDataAtualizacao = {
            "dataHora": "10/12/2023 14:08"
        };
        const jsonEstaticoCKPI = {
            "valorKPI": 40,
            "valorMeta": 85,
            "valorComparativo": 40,
            "thrTermometro": "#c73c2b"
        };
        let retorno = {
            cards: jsonEstaticoCards,
            usuario: jsonEstaticoUsuario,
            dataAtualizacao: jsonEstaticoDataAtualizacao,
            kpi: jsonEstaticoCKPI,
